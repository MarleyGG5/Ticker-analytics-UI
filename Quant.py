...
class MarketDashboard:
	...
	def run_analysis(self):
		try:
			...
			self.summary.to_csv("stock_performance_summary.csv", index=True, index_label="Ticker")
			self._show_summary()
			self._show_performance()
			self._show_risk()
			self._show_correlation()
			self.status_var.set(f"Updated for {self.analysis_label}. CSV saved as stock_performance_summary.csv")
